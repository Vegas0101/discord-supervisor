...
client.on("guildMemberAdd", member => {
  member.setNickname(`• İsim ' Yaş`) 
        ...
        client.on("userUpdate", async(old, nev) => {
          ...
          let sunucu = ayarlar.guildID

          let takmaad =  client.guilds.cache.get(sunucu).members.cache.get(nev.id).displayName


           if(old.username !== nev.username) {
           if(!nev.username.includes("ᛟ") && client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.cache.has(ayarlar.familyR)) {
               setTimeout(function(){
             let değişeceksembol1 = takmaad.replace(/ᛟ/g,"•");
                 client.guilds.cache.get(sunucu).members.cache.get(nev.id).setNickname(değişeceksembol1)
                   },  (900));
             client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.remove(ayarlar.familyR)
              client.channels.cache.get('836133099855282196').send(`\` > \` **${nev}, "ᛟ" tagını çıkardığı için <@&${ayarlar.familyR}> rolü alındı!**`)
          client.guilds.cache.get(sunucu).members.cache.get(nev.id).send(`** Tagımızı çıkardığın için senden <@&${ayarlar.familyR}> rolünü aldım. **`)
                client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.remove(ayarlar.familyR)
         
           } 
              if(nev.username.includes("ᛟ") && !client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.cache.has(ayarlar.familyR)) {
                 setTimeout(function(){
                let değişeceksembol2 = takmaad.replace(/•/g,"ᛟ");
                 client.guilds.cache.get(sunucu).members.cache.get(nev.id).setNickname(değişeceksembol2)
                     },  (900));
                client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.add(ayarlar.familyR)
                client.channels.cache.get('836133099855282196').send(`\` > \` **${nev}, "ᛟ" tagını aldığı için <@&${ayarlar.familyR}> rolü verildi!**`) 
                      client.guilds.cache.get(sunucu).members.cache.get(nev.id).send(" ** Tagımızı alıp bize destek verip kırmadığın için teşekkür ederiz ** ")
                client.guilds.cache.get(sunucu).members.cache.get(nev.id).roles.add(ayarlar.familyR)
              }
           }
           })
