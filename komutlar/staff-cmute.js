...
if(!message.member.roles.cache.has(conf.muteH)) return message.react(conf.carpi)
...
client.channels.cache.get("834693448275460109").send(`**${kullanıcı}** aldığı \`#${cezaID+1}\` numaralı ceza ile **${cezapuan}** ceza puanına ulaştı. (\`10\`)`)
