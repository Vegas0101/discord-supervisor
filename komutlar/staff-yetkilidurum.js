...
<:yldz:846443093699461170> Toplam Kayıtları: **Toplam ${toplamkayıt}** (\`${erkekkayıt} erkek, ${kızkayıt} kız\`)
<:yldz:846443093699461170> Toplam Ceza-i İşlemleri: **Toplam ${CmAtma+VmAtma+BanAtma+kickAtma+jailAtma} Ceza İşlemi**;
(\`ChatMute: ${CmAtma} VoiceMute: ${VmAtma} Ban: ${BanAtma} Kick: ${kickAtma} Jail: ${jailAtma}\`)

<:yldz:846443093699461170> Toplam Davetleri: **Toplam ${a} davet** (\`${ayrılan} ayrılan, ${fakea} fake, ${bonus} bonus\`)
<:yldz:846443093699461170> Yetkili Puanı: **${yetkilipuan} ${ayarlar.mavitac}**
<:yldz:846443093699461170> Toplam Aldığı Yetkili Sayısı: **${yetkilialdırma}**

<a:elmas:838373500359016488> Yetkileri;
